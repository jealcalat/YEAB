esplot <- function(x, y = NULL,
  ...
  layout.widths <-
    list(
      ...
      units =
        c(
          ylab = if (is.null(ylab)) "null" else "strheight",
          axis = "grobwidth",
          panel = "null",
          density = "snpc"
        ),
  ...
  layout.heights <-
    list(
      ...
      units =
        c(
          main = if (is.null(main)) "null" else "strheight",
          density = "snpc",
          panel = "null",
          axis = "lines",
